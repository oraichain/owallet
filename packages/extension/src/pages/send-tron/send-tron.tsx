...
export const SendTronPage: FunctionComponent<{
  ...
  useEffect(() => {
    if (TronWeb) {
      (async () => {
        ...
        // );
        // const signedtxn = await tronWeb.trx.sign(tradeobj, 'e35f9880a32d047c2cc06abcd6ac918f428262f7f19dc9e6770652372a85a9cc');
        // console.log('🚀 ~ data:', tradeobj);
        // console.log("🚀 ~ data signed:", estimateBandwidth(signedtxn) , 'bandwidth')
        const test2 = await tronWeb.transactionBuilder.estimateEnergy(
